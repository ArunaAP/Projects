...
<center>
	...
	<div class="button100">
				<a href="insert_payment.php"> <button> Insert</button></a>
				<a href="payment_view.php"> <button> Edit</button></a>
				<a href="payment_view.php"> <button>View</button></a>
				<a href="payment_view.php"> <button>Search</button></a>
