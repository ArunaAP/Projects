...
<center>
<img src="Images/Bronze img1.jpg" height="457px" width="1200px">
</center>
<br>
<div class="Goldenall">
<h2 style="font-size: 40px" class="mtitle" >Bronze Pensioner life Insurance</h2>
...
Soft Metric Life has perceived this, and we have the ideal answer for you, Bronze Pensioner, life insurance policy plan in Sri Lanka.
</h3>
...
<h2 class="poliPara">Bronze Pensioner is a life insurance plan for retired senior citizens. Where you can obtain a comprehensive life cover for an affordable premium.</h2>
<hr>
<h2 style= "color:#fec20f" class="polititle">Benefits</h2>

<h2 class="poliPara">Life insurance cover will be paid immediately to the policyholder’s beneficiaries at the time of an untimely death with any additional benefits they might have added to their plan.</h2>
<hr>
<h2 style= "color:#fec20f" class="polititle">Who can apply?</h2>

<h2 class="poliPara">Retired senior citizens. </h2>
<hr>
