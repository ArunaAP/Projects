...
<div class="climg">
<img src ="Images/claim.gif" width="400px" height="250px">
</div>
<center>
<div class="box22">
<form method="post" action="claim_details.php">
<div class="hdtxt">
<label>Enter your policyholder id number</label><br></div>
<div class="input">
...
?>
&nbsp;&nbsp;&nbsp;<a href="welcome.php"><button class="btn11">Back</button></a>
</center>	
<br>
<?php
