...
<center>
	...
	<div class="button100">
				<a href="insert agent details.php"> <button> Insert</button></a>
				<a href="agent_view.php"><button> Edit</button></a>
				<a href="agent_view.php"><button>View</button></a>
				<a href="agent_view.php"><button>Search</button></a>
